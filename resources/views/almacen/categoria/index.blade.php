...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Listado de Categorías <a href="categoria/create"><button class="btn btn-success">Nuevo</button>
			<a href="{{URL::action('PdfController@categorias')}}"><button class="btn btn-success">Print</button></a>
		</a></h3>
