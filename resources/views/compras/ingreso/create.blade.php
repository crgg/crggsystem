...
@section ('contenido')
    ...
    <div class="row">
    	<div class="col-lg-012 col-sm-12 col-md-12 col-xs-12">
    	...
    	<div class="col-lg-04 col-sm-4 col-md-4 col-xs-12">
    	   <div class="form-group">
        ...
        <div class="panel panel-primary">
           <div class="panel-body">
               <div class="col-lg-03 col-sm-3 col-md-3 col-xs-12">
                   <div class="form-group">
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                 ...
                 <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        <label for="precio_compra">Precio Compras</label>
    ...
    $('#guardar').hide();
        ...
        function agregar() 
        {
            ...
            if (idarticulo !="" && cantidad != "" && cantidad>0 && precio_compra !="" && precio_venta!="") {
                ...
                alert("que estas haciendo CTM todo vacio");
            }
