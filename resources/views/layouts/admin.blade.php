    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('dashboard/')}}" class="logo">
          ...
          <span class="logo-lg"><b>CRGG SYSTEM</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Ramon Gajardo</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Ramon Gajardo - Desarrollando Software
                      <small>www.ramon.com</small>
                    </p>
                  </li>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-th"></i>Ingresos</a></li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017-2020 <a href="#">CRGG</a>.</strong> All rights reserved.
      </footer>
